...
class AIService:
    ...
    # Future methods for LLM integration (not implemented yet):
    # def send_to_llm(self, prompt: str, model: str = "gpt-4") -> str:
    # def process_with_llm(self, video_id: str, cache_dir: str, metadata: Dict[str, Any], 
    #                     flattened_subtitles: str) -> str:
    # def batch_process_videos(self, video_list: List[str]) -> List[str]:
    # def connect_to_openai(self, api_key: str) -> None:
    # def connect_to_anthropic(self, api_key: str) -> None:
    # def connect_to_local_llm(self, endpoint: str) -> None:
